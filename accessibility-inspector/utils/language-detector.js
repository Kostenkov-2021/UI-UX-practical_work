/*
 * A11yLanguageDetector local bundle.
 * Includes code derived from MIT packages: franc-min@6.2.0, trigram-utils@2.0.1,
 * n-gram@2.0.2, collapse-white-space@2.1.0, and langs@2.0.0.
 * Generated for the browser extension; do not edit by hand.
 */
(function (global) {
  'use strict'
...
for (script in data) {
  if (francOwn.call(data, script)) {
    ...
    for (name in languages) {
      if (francOwn.call(languages, name)) {
...
function getTopScript(value, scripts) {
  ...
  for (script in scripts) {
    if (francOwn.call(scripts, script)) {
...
function getDistances(trigrams, languages, only, ignore) {
  ...
  if (languages) {
    for (language in languages) {
      if (francOwn.call(languages, language)) {
...
const ISO_CODE_MAP = {"ab":"ab","abk":"ab","aa":"aa","aar":"aa","af":"af","afr":"af","ak":"ak","aka":"ak","sq":"sq","sqi":"sq","alb":"sq","am":"am","amh":"am","ar":"ar","ara":"ar","an":"an","arg":"an","hy":"hy","hye":"hy","arm":"hy","as":"as","asm":"as","av":"av","ava":"av","ae":"ae","ave":"ae","ay":"ay","aym":"ay","az":"az","aze":"az","bm":"bm","bam":"bm","ba":"ba","bak":"ba","eu":"eu","eus":"eu","baq":"eu","be":"be","bel":"be","bn":"bn","ben":"bn","bh":"bh","bih":"bh","bi":"bi","bis":"bi","bs":"bs","bos":"bs","br":"br","bre":"br","bg":"bg","bul":"bg","my":"my","mya":"my","bur":"my","ca":"ca","cat":"ca","ch":"ch","cha":"ch","ce":"ce","che":"ce","ny":"ny","nya":"ny","zh":"zh","zho":"zh","chi":"zh","cv":"cv","chv":"cv","kw":"kw","cor":"kw","co":"co","cos":"co","cr":"cr","cre":"cr","hr":"hr","hrv":"hr","cs":"cs","ces":"cs","cze":"cs","da":"da","dan":"da","dv":"dv","div":"dv","nl":"nl","nld":"nl","dut":"nl","dz":"dz","dzo":"dz","en":"en","eng":"en","eo":"eo","epo":"eo","et":"et","est":"et","ee":"ee","ewe":"ee","fo":"fo","fao":"fo","fj":"fj","fij":"fj","fi":"fi","fin":"fi","fr":"fr","fra":"fr","fre":"fr","ff":"ff","ful":"ff","gl":"gl","glg":"gl","ka":"ka","kat":"ka","geo":"ka","de":"de","deu":"de","ger":"de","el":"el","ell":"el","gre":"el","gn":"gn","grn":"gn","gu":"gu","guj":"gu","ht":"ht","hat":"ht","ha":"ha","hau":"ha","he":"he","heb":"he","hz":"hz","her":"hz","hi":"hi","hin":"hi","ho":"ho","hmo":"ho","hu":"hu","hun":"hu","ia":"ia","ina":"ia","id":"id","ind":"id","ie":"ie","ile":"ie","ga":"ga","gle":"ga","ig":"ig","ibo":"ig","ik":"ik","ipk":"ik","io":"io","ido":"io","is":"is","isl":"is","ice":"is","it":"it","ita":"it","iu":"iu","iku":"iu","ja":"ja","jpn":"ja","jv":"jv","jav":"jv","kl":"kl","kal":"kl","kn":"kn","kan":"kn","kr":"kr","kau":"kr","ks":"ks","kas":"ks","kk":"kk","kaz":"kk","km":"km","khm":"km","ki":"ki","kik":"ki","rw":"rw","kin":"rw","ky":"ky","kir":"ky","kv":"kv","kom":"kv","kg":"kg","kon":"kg","ko":"ko","kor":"ko","ku":"ku","kur":"ku","kj":"kj","kua":"kj","la":"la","lat":"la","lb":"lb","ltz":"lb","lg":"lg","lug":"lg","li":"li","lim":"li","ln":"ln","lin":"ln","lo":"lo","lao":"lo","lt":"lt","lit":"lt","lu":"lu","lub":"lu","lv":"lv","lav":"lv","gv":"gv","glv":"gv","mk":"mk","mkd":"mk","mac":"mk","mg":"mg","mlg":"mg","ms":"ms","msa":"ms","may":"ms","ml":"ml","mal":"ml","mt":"mt","mlt":"mt","mi":"mi","mri":"mi","mao":"mi","mr":"mr","mar":"mr","mh":"mh","mah":"mh","mn":"mn","mon":"mn","na":"na","nau":"na","nv":"nv","nav":"nv","nd":"nd","nde":"nd","ne":"ne","nep":"ne","ng":"ng","ndo":"ng","nb":"nb","nob":"nb","nn":"nn","nno":"nn","no":"no","nor":"no","ii":"ii","iii":"ii","nr":"nr","nbl":"nr","oc":"oc","oci":"oc","oj":"oj","oji":"oj","cu":"cu","chu":"cu","om":"om","orm":"om","or":"or","ori":"or","os":"os","oss":"os","pa":"pa","pan":"pa","pi":"pi","pli":"pi","fa":"fa","fas":"fa","per":"fa","pl":"pl","pol":"pl","ps":"ps","pus":"ps","pt":"pt","por":"pt","qu":"qu","que":"qu","rm":"rm","roh":"rm","rn":"rn","run":"rn","ro":"ro","ron":"ro","rum":"ro","ru":"ru","rus":"ru","sa":"sa","san":"sa","sc":"sc","srd":"sc","sd":"sd","snd":"sd","se":"se","sme":"se","sm":"sm","smo":"sm","sg":"sg","sag":"sg","sr":"sr","srp":"sr","gd":"gd","gla":"gd","sn":"sn","sna":"sn","si":"si","sin":"si","sk":"sk","slk":"sk","slo":"sk","sl":"sl","slv":"sl","so":"so","som":"so","st":"st","sot":"st","es":"es","spa":"es","su":"su","sun":"su","sw":"sw","swa":"sw","ss":"ss","ssw":"ss","sv":"sv","swe":"sv","ta":"ta","tam":"ta","te":"te","tel":"te","tg":"tg","tgk":"tg","th":"th","tha":"th","ti":"ti","tir":"ti","bo":"bo","bod":"bo","tib":"bo","tk":"tk","tuk":"tk","tl":"tl","tgl":"tl","tn":"tn","tsn":"tn","to":"to","ton":"to","tr":"tr","tur":"tr","ts":"ts","tso":"ts","tt":"tt","tat":"tt","tw":"tw","twi":"tw","ty":"ty","tah":"ty","ug":"ug","uig":"ug","uk":"uk","ukr":"uk","ur":"ur","urd":"ur","uz":"uz","uzb":"uz","ve":"ve","ven":"ve","vi":"vi","vie":"vi","vo":"vo","vol":"vo","wa":"wa","wln":"wa","cy":"cy","cym":"cy","wel":"cy","wo":"wo","wol":"wo","fy":"fy","fry":"fy","xh":"xh","xho":"xh","yi":"yi","yid":"yi","yo":"yo","yor":"yo","za":"za","zha":"za","zu":"zu","zul":"zu"}

function normalizeLanguageCode(code) {
  if (!code) return ''
  const normalized = String(code).trim().toLowerCase().split('-')[0]
  return ISO_CODE_MAP[normalized] || normalized
}

function detectLanguage(value, options = {}) {
  const minLength = options.minLength || 20
  const results = francAll(value || '', {minLength})
  const alternatives = results.slice(0, options.maxAlternatives || 5).map(([iso3, confidence]) => ({
    iso3,
    lang: normalizeLanguageCode(iso3),
    confidence
  }))
  const best = alternatives[0] || {iso3: 'und', lang: 'und', confidence: 0}
  return {
    iso3: best.iso3,
    lang: best.lang,
...
global.A11yLanguageDetector = {
  detect: detectLanguage,
  detectAll(value, options = {}) {
    return detectLanguage(value, options).alternatives
  },
